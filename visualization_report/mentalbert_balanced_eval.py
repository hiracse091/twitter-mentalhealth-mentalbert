...
# -----------------------------
model_path = "./save_mentalbert_final"
...
report_df.to_csv("./plots/mentalbert_balanced_classification_report.csv")

# -----------------------------
# 6. Confusion Matrix
# -----------------------------
ConfusionMatrixDisplay.from_predictions(all_labels, all_preds, display_labels=label_names, xticks_rotation=45)
plt.title("Confusion Matrix - MentalBERT (Balanced)")
plt.tight_layout()
plt.savefig("./plots/mentalbert_balanced_confusion_matrix.png")
#plt.show()
